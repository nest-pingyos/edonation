                            ...
                            <div class="row align-items-center g-0">
                                <div class="col-lg-6 d-none d-lg-inline-block border-end">
                                    <div class="auth-page-sidebar">
                                        <img src="https://cdn.dribbble.com/users/1078347/screenshots/2799566/500_error.gif"
                                            alt="500 Server Error" class="img-fluid" />
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="p-4">
                                        <div class="mx-auto mb-4 text-center">
                                            ...
                                            <div class="text-center">
                                                ...
                                                <a href="javascript:location.reload();"
                                                    class="btn btn-outline-secondary ms-2">ลองใหม่</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
