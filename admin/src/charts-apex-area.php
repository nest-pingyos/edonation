                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title anchor" id="overview">
                                    Overview
                                    <a class="btn btn-sm btn-outline-success rounded-2 float-end" href="https://apexcharts.com/javascript-chart-demos/" target="_blank">
                                        Official Website
                                    </a>
                                </h5>
                                <p class="text-muted mb-3">
                                    ApexCharts is loaded with powerful
                                    features to fulfill your
                                ...
                                <p class="mb-0">
                                    <span class="fw-medium">Find the JS file for the following
                                        chart at:</span>
                                    <code>
                                        ../src/assets/js/components/apexchart-area.js</code>
                                </p>
                            </div>
                            <!-- end card-body -->
                        </div>
