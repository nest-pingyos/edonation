...
$localCssExists = file_exists(__DIR__ . '/../assets/css/app.css');
$basePath = '';  // Relative to the current page in src/
?>
...
<?php else: ?>
    ...
    <style>
        ...
        .menu-arrow[aria-expanded="true"]::after {
            transform: rotate(45deg);
        }
        ...
        .form-control:focus {
            border-color: var(--bs-primary);
            box-shadow: 0 0 0 3px rgba(28, 132, 238, 0.1);
        }
        ...
        .badge-soft-warning {
            background: rgba(249, 185, 49, 0.15);
            color: #f9b931;
        }
        ...
        .badge-soft-primary {
            background: rgba(28, 132, 238, 0.15);
            color: #1c84ee;
        }

        .badge-soft-secondary {
            background: rgba(93, 113, 134, 0.15);
            color: #5d7186;
        }
        ...
        .bg-soft-primary {
            background: rgba(28, 132, 238, 0.1) !important;
        }
        ...
        .bg-soft-danger {
            background: rgba(239, 95, 95, 0.1) !important;
        }

        .bg-soft-warning {
            background: rgba(249, 185, 49, 0.1) !important;
        }

        .bg-soft-info {
            background: rgba(78, 202, 194, 0.1) !important;
        }
