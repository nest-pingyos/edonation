...
if ($count > 0) {
    ...
    <table>
        ...
        <tr>
            <td width="60%"><b>ชื่อ/Name : </b>' . htmlspecialchars($inv_mst_data_row['payerAccountName']) . '</td>
            <td width="40%" align="right"><b>เลขที่ใบเสร็จ/Receipt No. </b>' . htmlspecialchars($inv_mst_data_row['fiscal_year']) . '-' . htmlspecialchars($inv_mst_data_row['receipt_no']) . '</td>
        </tr>
        <tr>
