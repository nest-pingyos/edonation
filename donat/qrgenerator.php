...
<body>
                ...
                <div id="qrContent" class="single-card" style="display: none;">
                    ...
                    <div class="payment-banner-area">
                        ...
                        <div class="thai-qr-banner" style="background: none; height: auto;">
                            ...
                            <img src="../assets/images/Thai_QR_Payment_Logo-01.jpg" alt="Thai QR Payment" style="width: 100%; height: auto; border-radius: 4px;">
                        </div>
                    ...
                    <div class="qr-area">
                        ...
                        <div id="statusBox">
                            <span class="badge badge-warning font-weight-normal px-3 py-2">
                                <span class="spinner-grow spinner-grow-sm mr-1" role="status" aria-hidden="true" style="vertical-align: middle;"></span>
                                รอการชำระเงิน...
                            </span>
                        </div>
                    </div>
    ...
    function renderData(data) {
        ...
        document.getElementById('qrImage').src = `qrcode_api.php?ref=${data.billPaymentRef1}&amount=${data.amount}&t=${timestamp}`;
    }
