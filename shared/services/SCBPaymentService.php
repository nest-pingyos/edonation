 ...
 * 
 * ไฟล์นี้สามารถใช้ได้จากทั้ง web และ api
 * 
 * Features:
...
class SCBPaymentService
{
    ...
    /**
     * Constructor - ตรวจสอบ constants ที่จำเป็น
     */
    ...
    public function getAccessToken(): ?string
    {
        ...
        if (!defined('SCB_API_KEY') || empty(SCB_API_KEY)) {
            error_log("SCBPaymentService: SCB_API_KEY not configured");
            return null;
        }
    ...
    public function createQRCode(float $amount, string $ref1, string $ref2 = ''): ?array
    {
        ...
        $expiryMinutes = defined('SCB_QR_EXPIRY_MINUTES') ? SCB_QR_EXPIRY_MINUTES : 30;
        ...
        $body = [
            'qrType' => defined('SCB_QR_TYPE') ? SCB_QR_TYPE : 'PP',
            'ppType' => defined('SCB_PP_TYPE') ? SCB_PP_TYPE : 'BILLERID',
            'ppId' => SCB_BILLER_ID,
            'amount' => number_format($amount, 2, '.', ''),
            'ref1' => $ref1,
            'ref2' => $ref2,
            'ref3' => defined('SCB_REF3') ? SCB_REF3 : 'EDN',
            'numberOfTimes' => defined('SCB_QR_NUMBER_OF_TIMES') ? SCB_QR_NUMBER_OF_TIMES : 1,
